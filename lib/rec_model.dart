class RecModel {
  ...
  RecModel({this.recipes, this.total, this.skip, this.limit});

  RecModel.fromJson(Map<String, dynamic> json) {
    if (json['recipes'] != null) {
      recipes = <RecipesClass>[];
      json['recipes'].forEach((v) {
        recipes!.add(new RecipesClass.fromJson(v));
      });
    }
    total = json['total'];
    skip = json['skip'];
...
class RecipesClass {
  ...
  RecipesClass.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];
